		...
		if (cmdlabel.equalsIgnoreCase("enderchest") || cmdlabel.equalsIgnoreCase("ec")) {
			if(args.length == 2)
			{
				if(args[0].equalsIgnoreCase("create")) {
					if(args[1].equals("?")) sender.sendMessage(Config.currentLocale.usage_create);
					else {
					...
					if(args[1].equals("?")) sender.sendMessage(Config.currentLocale.usage_acreate);
					...
					if(args[1].equals("?")) sender.sendMessage(Config.currentLocale.usage_invite);
					else {
					...
					if(args[1].equals("?")) sender.sendMessage(Config.currentLocale.usage_accept);
					else {
					...
					if(args[1].equals("?")) sender.sendMessage(Config.currentLocale.usage_kick);
					else {
					...
					if(args[1].equals("?")) sender.sendMessage(Config.currentLocale.usage_leaveowner);
					else {
			...
			if(args.length == 0 || args[0].equals("?") || args[0].equals("help")) {
				sender.sendMessage(ChatColor.GRAY + "������ ������: (/enderchest = /ec)");
				sender.sendMessage(ChatColor.GRAY + "   /enderchest create <groupname> - ������� ������.");
				sender.sendMessage(ChatColor.GRAY + "   /enderchest delete [groupname] - ������� ������.");
				sender.sendMessage(ChatColor.GRAY + "   /enderchest invite <nickname> - ���������� ������ � ������.");
				sender.sendMessage(ChatColor.GRAY + "   /enderchest kick <nickname> - ������� ������ �� ������.");
				sender.sendMessage(ChatColor.GRAY + "   /enderchest accept <groupname> - ������� ����������� � ������.");
				sender.sendMessage(ChatColor.GRAY + "   /enderchest leave [new owner nickname] - ����� �� ������.");
				sender.sendMessage(ChatColor.GRAY + "   /enderchest info - ���������� � ������� ������.");
				sender.sendMessage(ChatColor.GRAY + "   /enderchest changeowner <nickname> - ������� ��������� ������.");
				sender.sendMessage(ChatColor.GRAY + "   /enderchest acreate <groupname> - ������� ���������������� ������.");
			}
			else {
				sender.sendMessage(ChatColor.GRAY + "   /enderchest <help ��� ?> - ������ �� ��������");
			}
		}
		return true;
	}
